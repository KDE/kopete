...
struct ListView::Private
{
	...
	//! This will be the target scroll bar position in the maxValue() minValue() boundary of the bar.
	...
	//! The timer which will simulate continous play for line step buttons in scrollview
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Bugs: * Scroll bar loses it's onMouseOver color when we drag the scroll bar and move the mouse outside
