...
//	dialogUi->listView->addColumn(i18n("End Date"));
    ...
    if (subTitle == i18n("General information")) {
        ...
        generalHTMLPart->write(i18n("<b title=\"The last time %1 was online or away\">Last time present :</b> %2", m_contact->metaContact()->displayName(), QLocale().toString(
                                        m_contact->lastPresent())));
        generalHTMLPart->write(QStringLiteral("</div>"));
