...
QString PipesPlugin::createXml ( const Kopete::Message & msg )
{
	...
	<message subject=""
		...
		type="normal"
		mainContactId="captainbeah"
		time="11:06 am" >
		<from>
			<contact contactId="darthpinky37"
				protocolIcon="aim_protocol"
				userPhoto="/home/kde-devel/.kde4/share/apps/kopete/oscarpictures/darthpinky37.jpg" >
				<contactDisplayName dir="ltr" text="darthpinky37" />
				<metaContactDisplayName dir="ltr"
					text="captainbeah@gmail.com (E-mail Address Not Verified)" />
			</contact>
		</from>
		<to>
			<contact contactId="captainbeah"
				protocolIcon="aim_protocol"
				userPhoto="/home/kde-devel/.kde4/share/apps/kopete/avatars/User/7e542903e0ac7519a7496e85f5a5b99d.png" >
				<contactDisplayName dir="ltr" text="captainbeah" />
				<metaContactDisplayName dir="ltr" text="Charles Connell" />
			</contact>
			</to>
		<body dir="ltr"
			bgcolor="#000000"
