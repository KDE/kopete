...
//extern QCoreApplication *qApp; ///@see Debug::Indent
...
namespace Debug
{
    ...
    {
        friend QString& indent();
        Indent() : QObject( QCoreApplication::instance()), m_string("") { setObjectName("DEBUG_indent"); }
        QString m_string;
    };

    inline QString& indent()
    {
        QObject *o = QCoreApplication::instance() ? QCoreApplication::instance()->findChild<QObject*>( "DEBUG_indent" ) : 0;
        ...
        static inline kdbgstream debug()   { return kdbgstream( (const char*)indent().toLatin1(), 0, KDEBUG_INFO  ) << AMK_PREFIX; }
        static inline kdbgstream warning() { return kdbgstream( (const char*)indent().toLatin1(), 0, KDEBUG_WARN  ) << AMK_PREFIX << "[WARNING!] "; }
        static inline kdbgstream error()   { return kdbgstream( (const char*)indent().toLatin1(), 0, KDEBUG_ERROR ) << AMK_PREFIX << "[ERROR!] "; }
        static inline kdbgstream fatal()   { return kdbgstream( (const char*)indent().toLatin1(), 0, KDEBUG_FATAL ) << AMK_PREFIX; }
...
#define DEBUG_INDENT Debug::indent().append(QString("  "));
// += "  ";
