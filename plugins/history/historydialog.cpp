    ...
    , mSearching(false)
{
    ...
    fontStyle = "<style>.hf { font-size:" + fontSize + ".0pt; font-family:" + Kopete::AppearanceSettings::self()->chatFont().family() + "; color: "
...
void HistoryDialog::slotSearch()
{
    ...
    if (mMainWidget->dateTreeWidget->topLevelItemCount() == 0) {
        return;
    }
