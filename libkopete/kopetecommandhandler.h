...
public:
     ...
     */
    enum CommandType {
        Normal, SystemAlias, UserAlias, Undefined
    };
     ...
     */
    void registerCommand(QObject *parent, const QString &command, const char *handlerSlot, const QString &help = QString(), uint minArgs = 0, int maxArgs = -1,
