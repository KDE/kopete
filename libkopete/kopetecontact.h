...
#if 0  //TODO  move to protocol capabilities
	/**
...
signals:
	 ...
	 */
	void onlineStatusChanged( Contact *contact,
		const OnlineStatus &status, const OnlineStatus &oldStatus );
	 ...
	 */
	void contactDestroyed( Contact *contact );
 ...
 private:  /*signals*/
	 ...
	 */
	void idleStateChanged( Contact *contact );
