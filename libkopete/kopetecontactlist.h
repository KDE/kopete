...
signals:
	 ...
	 */
	void metaContactAdded( MetaContact *mc );
	/**
	 * A metacontact has just been removed.  and will be soon deleted
	 */
	void metaContactRemoved( MetaContact *mc );
	 ...
	 */
	void groupRemoved( Group * );
	/**
	 * A group has just been renamed
	 */
	void groupRenamed(Group *, const QString & oldname);

	/**
	 * A contact has been added to a group
	 */
	void metaContactAddedToGroup( MetaContact *mc, Group *to );
	/**
	 * A contact has been removed from a group
	 */
	void metaContactRemovedFromGroup( MetaContact *mc, Group *from );
...
#if 0 //I think all theses method should be moved to the decop interface.
	/**
...
#if 0
private:  //or public, or public slots
	/**
	 * @internal
