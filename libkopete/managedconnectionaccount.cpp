...
ManagedConnectionAccount::ManagedConnectionAccount( Protocol *parent, const QString &acctId, uint maxPasswordLength  )
	: PasswordedAccount( parent, acctId, maxPasswordLength, false ), m_waitingForConnection( false )
{
