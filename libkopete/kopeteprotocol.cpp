    ...
    , d(new Private())
{
    ...
    d->unloading = false;
    d->accountNotConnectedStatus
        = Kopete::OnlineStatus(Kopete::OnlineStatus::Unknown, 0, this, Kopete::OnlineStatus::AccountOffline, QStringList(QLatin1String("account_offline_overlay")), i18n("Account Offline"));
}
...
Contact *Protocol::deserializeContact(
    MetaContact *metaContact, const QMap<QString, QString> &serializedData, const QMap<QString, QString> &addressBookData)
{
    Q_UNUSED(metaContact)
