...
signals:
	 ...
	 */
	void accountUnregistered( const Account *account );
	 ...
	 */
	void accountOnlineStatusChanged(Account *account,
...
private slots:
	...
	void slotAccountOnlineStatusChanged(Contact *c,
		const OnlineStatus &oldStatus, const OnlineStatus &newStatus);
	/**
	 * \internal
	 * Unregister the account.
	 */
	void unregisterAccount( const Account *account );
