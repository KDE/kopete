...
public:
	 ...
	 *
	 * The @ref MessageManager is only set if the message is already passed by the manager.
...
private:
	 ...
	 */
	void init( const QDateTime &timeStamp, const Contact *from, const QPtrList<Contact> &to,
