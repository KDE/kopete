                    ...
                    for (QStringList::iterator it = addresses.begin(); it != end; ++it) {
                        ...
                        if (otherMc) { // Is it in another metacontact?
                            ...
                            if (KMessageBox::Yes == KMessageBox::questionYesNo(Kopete::UI::Global::mainWidget(),
                                                                               i18n(
                                                                                   "<qt>An address was added to this contact by another application.<br />Would you like to use it in Kopete?<br /><b>Protocol:</b> %1<br /><b>Address:</b> %2</qt>",
                                                                                   proto->displayName(), *it), i18n("Import Address From Address Book"), KGuiItem(i18n("Use")),
                                                                               KGuiItem(i18n("Do Not Use")), QStringLiteral("ImportFromKABC"))) {
                                ...
                                if (!allAccountsConnected) {
                                    KMessageBox::queuedMessageBox(Kopete::UI::Global::mainWidget(), KMessageBox::Sorry,
                                                                  i18n(
                                                                      "<qt>One or more of your accounts using %1 are offline.  Most systems have to be connected to add contacts.  Please connect these accounts and try again.</qt>",
                                                                      protocolName),
                                                                  i18n("Not Connected"));
                                    continue;
                                }
                                ...
                                if (accountcount > 1) { // if we have >1 account in this protocol, prompt for the protocol.
                                    ...
                                    accSelector->setObjectName(QStringLiteral("accSelector"));
                                    ...
                                    KMessageBox::queuedMessageBox(Kopete::UI::Global::mainWidget(), KMessageBox::Sorry,
                                                                  i18n("<qt>You do not have an account configured for <b>%1</b> yet.  Please create an account, connect it, and try again.</qt>",
                                                                       protocolName),
