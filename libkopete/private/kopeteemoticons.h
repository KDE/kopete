...
public:
	 ...
	 **/
	Emoticons( const QString &theme = QString::null );	//krazy:exclude=nullstrassign for old broken gcc
	 ...
	 */
	static QList<Token> tokenizeEmoticons( const QString &message, ParseMode mode = DefaultParseMode );
...
private slots:
	 ...
	 **/
	void initEmoticons ( const QString &theme = QString::null );	//krazy:exclude=nullstrassign for old broken gcc
};
