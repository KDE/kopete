...
#ifndef KOPETEADDIDENTITYWIZARD_EXPORT
# if defined(MAKE_KOPETEADDIDENTITYWIZARD_LIB)
#  define KOPETEADDIDENTITYWIZARD_EXPORT KDE_EXPORT
# else
#  define KOPETEADDIDENTITYWIZARD_EXPORT KDE_IMPORT
# endif
#endif
