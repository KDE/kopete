 ...
 *
 * The Account class handles one account.
...
public:
	 ...
	 *
	 * \return the pointer to the Contact object for this
...
signals:
	 ...
	 * (emitted in the Account destructor, any virtual fucntion may not anymore be called)
	 */
	void accountDestroyed( const Account* );
...
public slots:
	 ...
	 */
	virtual void connect( const OnlineStatus& initialStatus = OnlineStatus() ) =0;
...
private slots:
	 ...
	 */
	void slotOnlineStatusChanged( Contact *contact, const OnlineStatus &newStatus, const OnlineStatus &oldStatus );
