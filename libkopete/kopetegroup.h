 ...
 */
class Group : public ContactListElement
{
...
public:
	 ...
	 * This function is actualy not realy efficient, and browse over each metacontact.
...
signals:
	 ...
	 */
	void displayNameChanged( Group *group , const QString &oldName );
