...
const QDateTime & KopeteMessage::timestamp() const
{
	return d->timeStamp;
}
...
const QColor & KopeteMessage::fg() const
{
	return d->fgColor;
}

const QColor & KopeteMessage::bg() const
{
	return d->bgColor;
}

const QFont & KopeteMessage::font() const
{
	return d->font;
}
