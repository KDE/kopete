...
public:
	 ...
	 */
	virtual Kopete::UI::AddContactPage *createAddContactWidget( QWidget *parent, Account *account ) = 0;
	 ...
	 */
	virtual Kopete::UI::EditAccountWidget * createEditAccountWidget( Account *account, QWidget *parent ) = 0;
