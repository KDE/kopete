...
{
public:
    KopeteCommandGUIClient(Kopete::ChatSession *manager) : QObject(manager)
...
void Kopete::CommandHandler::registerCommand(QObject *parent, const QString &command, const char *handlerSlot, const QString &help, uint minArgs, int maxArgs, const QKeySequence &cut,
                                             const QString &pix)
{
    ...
    Kopete::Command *mCommand = new Kopete::Command(parent, lowerCommand, handlerSlot, help,
                                                    Normal, QString(), minArgs, maxArgs, cut, pix);
...
void Kopete::CommandHandler::registerAlias(QObject *parent, const QString &alias, const QString &formatString, const QString &help, CommandType type, uint minArgs, int maxArgs,
                                           const QKeySequence &cut, const QString &pix)
{
