...
{
	kdDebug(14180) << k_funcinfo << " " << bytes <<" [bytes]"<< endl;
...
{
	kdDebug(14180) << k_funcinfo << "[bytes left: " <<  d->writeBuf.size() << " ]" << endl;
...
{
	kdDebug(14180) << k_funcinfo << "[data size: " << cs.length() << "]" << endl;
...
{
	kdDebug(14180) << k_funcinfo << "[data size: " << block.size() << "]" << endl;
...
{
	kdDebug(14180) << k_funcinfo << "[data size: " << size << "][ delete :" << del << " ]" << endl;
...
{
	kdDebug(14180) << k_funcinfo << "(THIS RETURNS -1)" << endl;
	return -1;
}
...
{
	kdDebug(14180) << k_funcinfo << "[int size] : " << size << " [bool del] " << del << endl;
