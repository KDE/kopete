...
{
// 	kDebug(14181) << "[bytes left: " <<  d->writeBuf.size() << " ]";
...
{
// 	kDebug(14181) << "[data size: " << block.size() << "]";
...
{
// 	kDebug(14181) << "[data size: " << size << "][ delete :" << del << " ]";
...
{
// 	kDebug(14181) << "[int size] : " << size << " [bool del] " << del;
