...
/* initialise Kopete::OnlineStatus that should be user selectable in the user interface */
	  ...
	  groupwiseAway       ( Kopete::OnlineStatus::Away,    18, this, 4, "groupwise_away", 
			i18n( "Away" ), i18n( "Go &Away" ), Kopete::OnlineStatusManager::Away, Kopete::OnlineStatusManager::HasAwayMessage ),
	  groupwiseAwayIdle   ( Kopete::OnlineStatus::Away,    15, this, 5, "groupwise_away", 
			i18n( "Idle" ), "FIXME: Make this unselectable", Kopete::OnlineStatusManager::Busy,
...
/* initialise Kopete::OnlineStatus used by the protocol, but that are not user selectable */
	  groupwiseUnknown    ( Kopete::OnlineStatus::Unknown, 25, this, 0, "status_unknown",
			i18n( "Unknown" ), "FIXME: Make this unselectable" ),
	  groupwiseInvalid( Kopete::OnlineStatus::Unknown, 25, this, 6, "status_unknown",
			i18n( "Invalid Status" ), "FIXME: Make this unselectable", Kopete::OnlineStatusManager::Offline,
			Kopete::OnlineStatusManager::HideFromMenu ),
	  groupwiseConnecting( Kopete::OnlineStatus::Unknown, 0, this, 99, "groupwise_connecting",
			i18n( "Connecting" ), "FIXME: Make this unselectable" ),
