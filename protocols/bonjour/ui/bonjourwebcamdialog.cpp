...
BonjourWebcamDialog::BonjourWebcamDialog( const QString &contactId, QWidget * parent )
: KDialog( parent )
{
...
BonjourWebcamDialog::~ BonjourWebcamDialog( )
{
#ifndef Q_OS_WIN
...
void BonjourWebcamDialog::slotUpdateImage()
{
#ifndef Q_OS_WIN
	mVideoDevicePool->getFrame();
...
#include "bonjourwebcamdialog.moc"
