/*
    bonjourfakeserver.h - Kopete Bonjour Protocol
...
#ifndef BONJOURFAKESERVER_H
#define BONJOURFAKESERVER_H

#include <QList>
#include <QObject>


class BonjourIncomingMessage;

/**
 * This is a interface to a dummy IM server
 * @author Will Stephenson
 */
class BonjourFakeServer : public QObject
{
	Q_OBJECT
public:
	BonjourFakeServer();
...
protected:
	 ...
	 */
	QList<BonjourIncomingMessage*> m_incomingMessages;
};
