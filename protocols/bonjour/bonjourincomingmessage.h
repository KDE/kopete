/*
    bonjourincomingmessage.h - Kopete Bonjour Protocol
...
#ifndef BONJOURINCOMINGMESSAGE_H
#define BONJOURINCOMINGMESSAGE_H
 ...
 */
class BonjourIncomingMessage : public QObject
{
Q_OBJECT
public:
	/**
	 ...
	 */
	BonjourIncomingMessage( BonjourFakeServer* const server , QString message );
	virtual ~BonjourIncomingMessage();
	/**
...
public slots:
	/**
	 * 'Deliver' the message to Kopete by calling BonjourFakeServer::incomingMessage().
