...
public:
    ...
    void resolve_instance_start(ServiceResolver::Private *np, const QByteArray &name)
    {
        ...
        if (!p_serv) {
            ...
            connect(p_serv, SIGNAL(resolve_resultsReady(int,QList<XMPP::ServiceProvider::ResolveResult>)), SLOT(provider_resolve_resultsReady(int,
