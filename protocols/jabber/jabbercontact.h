...
class JabberContact:public KopeteContact {
  ...
  public:
	 ...
	 */
    void slotResourceAvailable(const Jabber::Jid & jid,
			       const Jabber::Resource & resource);

	/**
	 * Remove a resource from the contact
	 */
    void slotResourceUnavailable(const Jabber::Jid & jid,
				 const Jabber::Resource & resource);
	...
	*/
	 ...
	 */
    void slotUpdatePresence(const KopeteOnlineStatus & newStatus,
  ...
  private:
	...
	*actionStatusXA, *actionStatusDND, *actionStatusInvisible;
