...
MessengerEditAccountWidget::MessengerEditAccountWidget ( MessengerProtocol * proto, MessengerAccount * account, QWidget * parent =0)
: QWidget( parent ), KopeteEditAccountWidget( account )
{
	...
	// TODO: do the methods of the messenger account useful to access to messenger account data
// 		if ( ( account->serverName() != MESSENGER_DEFAULT_SERVER ) 
// 				|| ( account->serverPort() != MESSENGER_DEFAULT_PORT) ) {
