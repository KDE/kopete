...
class QMember : public QObject
{
	...
	public slots:
		...
		{
			//kDebug(14120) << k_funcinfo << id << endl;
			mapping->exec(id);
		}
...
class QMemberSingle : public QObject
{
	...
	public slots:
		...
		{
			//kDebug(14120) << k_funcinfo << id << " : " << arg  << endl;
			mapping->exec(id,arg);
		}
...
class QMemberDouble : public QObject
{
	...
	public slots:
		...
		{
			//kDebug(14120) << k_funcinfo << id << " : " << arg << " : " << arg2 << endl;
...
class QMemberTriple : public QObject
{
	...
	public slots:
		...
		{
			//kDebug(14120) << k_funcinfo << id << " : " << arg << " : " << arg2 << " : " << arg3 << endl;
