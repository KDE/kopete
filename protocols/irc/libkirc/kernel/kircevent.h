...
class KIRC_EXPORT CommandEvent : public QEvent
{
...
class KIRC_EXPORT MessageEvent : public QEvent
{
    static const QEvent::Type Type;
...
public:
    ...
    inline const KIrc::Message &message() const
    {
        return m_message;
    }

    inline KIrc::Socket *socket()
    {
        return m_socket;
    }
...
class KIRC_EXPORT TextEvent : public QEvent
{
public:
    static const QEvent::Type Type;
/*
...
*/
    ...
    KIrc::EntityPtr from() const
    {
        return m_from;
    }

    KIrc::EntityList to() const
    {
        return m_to;
    }
