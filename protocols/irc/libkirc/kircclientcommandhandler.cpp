/*
    ...
    Copyrigth (c) 2003-2005 by Michel Hermier <michel.hermier@wanadoo.fr>
...
void ClientCommandHandler::receivedServerMessage(Message msg)
{
	receivedServerMessage(msg, msg.suffix());
}

void ClientCommandHandler::receivedServerMessage(Message msg, const QString &message)
{
//	emit receivedMessage(InfoMessage, msg.prefix(), Entity::List(), message);
}
/*
void ClientCommandHandler::registerStandardCommands(CommandManager *cm)
{
...
void ClientCommandHandler::error(Message /*msg*/)
{
//	d->client->close();
}
 ...
 */
void ClientCommandHandler::join(Message msg)
{
/*
	if (msg.argsSize()==1)
 ...
 */
void ClientCommandHandler::kick(Message msg)
{
/*
 ...
 * "<nickname> *( ( "+" / "-" ) *( "i" / "w" / "o" / "O" / "r" ) )"
 */
void ClientCommandHandler::mode(Message msg)
{
 ...
 * "<nickname>"
 */
void ClientCommandHandler::nick(Message msg)
{
/*
...
void ClientCommandHandler::notice(Message msg)
{
 ...
 */
void ClientCommandHandler::part(Message msg)
{
/*
	emit receivedMessage(
		PartMessage,
...
void ClientCommandHandler::ping(Message imsg)
{
	Message msg;
	msg.setCommand(PONG);
...
void ClientCommandHandler::pong(Message /*msg*/)
{
}

void ClientCommandHandler::privmsg(Message msg)
{
/*
	if (!msg.suffix().isEmpty())
	{
...
void ClientCommandHandler::quit(Message msg)
{
/*
	emit receivedMessage(
		QuitMessage,
 ...
 */
void ClientCommandHandler::topic(Message msg)
{
/*
 ...
 */
/*
void ClientCommandHandler::bindNumericReplies()
{
 ...
 */
void ClientCommandHandler::numericReply_001(Message msg)
{
...
//	d->client->setConnectionState(KIRC::Socket::Open);
}

/* 002: ":Your host is <servername>, running version <ver>"
 * Gives information about the host. The given informations are close to 004.
 */
void ClientCommandHandler::numericReply_002(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_003(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_004(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_005(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_250(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_251(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_252(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_253(Message msg)
{
 ...
 *  */
void ClientCommandHandler::numericReply_254(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_255(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 * Server is too busy.
 */
void ClientCommandHandler::numericReply_263(Message msg)
{
 ...
 * NOT IN RFC2812
 */
void ClientCommandHandler::numericReply_265(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_266(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_301(Message msg)
{
/*
...
/* 303: ":*1<nick> *(" " <nick> )"
 */
void ClientCommandHandler::numericReply_303(Message msg)
{
/*
 ...
 */
void ClientCommandHandler::numericReply_305(Message msg)
{
/*
 ...
 */
void ClientCommandHandler::numericReply_306(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_307(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_311(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_312(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_313(Message msg)
{
 ...
 * Show WHOWAS Info
 */
void ClientCommandHandler::numericReply_314(Message msg)
{
 ...
 * End of WHO list.
 */
void ClientCommandHandler::numericReply_315(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_317(Message msg)
{
/*
 ...
 */
void ClientCommandHandler::numericReply_318(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_319(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_320(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_322(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_323(Message msg)
{
	emit receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_324(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_328(Message msg)
{
 ...
 * NOT IN RFC1459 NOR RFC2812
 */
void ClientCommandHandler::numericReply_329(Message msg)
{
}
 ...
 */
void ClientCommandHandler::numericReply_331(Message msg)
{
 ...
 * Gives the existing topic for a channel after a join.
 */
void ClientCommandHandler::numericReply_332(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_333(Message msg)
{
/*
	QDateTime d;
 ...
 * WHO Reply
 */
void ClientCommandHandler::numericReply_352(Message msg)
{
/*
 ...
 * NAMES list
 */
void ClientCommandHandler::numericReply_353(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_366(Message msg)
{
	emit receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_369(Message msg)
{
	emit receivedServerMessage(msg);
}
 ...
 * Part of the MOTD.
 */
void ClientCommandHandler::numericReply_372(Message msg)
{
 ...
 * End of the motd.
 */
void ClientCommandHandler::numericReply_376(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_401(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_404(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_406(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_422(Message msg)
{
	receivedServerMessage(msg);
}
 ...
 */
void ClientCommandHandler::numericReply_433(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_442(Message msg)
{
 ...
 * Bad server password
 */
void ClientCommandHandler::numericReply_464(Message /*msg*/)
{
 ...
 * Channel is Full
 */
void ClientCommandHandler::numericReply_471(Message msg)
{
 ...
 * Invite Only.
 */
void ClientCommandHandler::numericReply_473(Message msg)
{
 ...
 * Banned.
 */
void ClientCommandHandler::numericReply_474(Message msg)
{
 ...
 * Wrong Chan-key.
 */
void ClientCommandHandler::numericReply_475(Message msg)
{
 ...
 */
void ClientCommandHandler::numericReply_477(Message msg)
{
...
/*
void ClientCommandHandler::bindCtcp()
{
...
void ClientCommandHandler::CtcpQuery_action(Message msg)
{
...
bool ClientCommandHandler::CtcpReply_action(Message msg)
{
}
*/

//	FIXME: the API can now answer to help commands.
void ClientCommandHandler::CtcpQuery_clientinfo(Message msg)
{
...
void ClientCommandHandler::CtcpQuery_dcc(Message msg)
{
//	Message &ctcpMsg = msg.ctcpMessage();
	Message ctcpMsg;
...
bool ClientCommandHandler::CtcpReply_dcc(Message msg)
{
}
*/

void ClientCommandHandler::CtcpReply_errmsg(Message /*msg*/)
{
	// should emit one signal
}

void ClientCommandHandler::CtcpQuery_finger(Message /*msg*/)
{
	// To be implemented
}

void ClientCommandHandler::CtcpQuery_ping(Message msg)
{
//	writeCtcpReplyMessage(	msg.prefix(), QString::null,
//				msg.ctcpMessage().command(), msg.ctcpMessage().arg(0));
}

void ClientCommandHandler::CtcpReply_ping(Message msg)
{
/*	timeval time;
...
void ClientCommandHandler::CtcpQuery_source(Message msg)
{
//	writeCtcpReplyMessage(msg.prefix(), QString::null,
//			      msg.ctcpMessage().command(), m_SourceString);
}

void ClientCommandHandler::CtcpQuery_time(Message msg)
{
//	writeCtcpReplyMessage(msg.prefix(), QString::null,
...
void ClientCommandHandler::CtcpQuery_userinfo(Message msg)
{
...
void ClientCommandHandler::CtcpQuery_version(Message msg)
{
...
void ClientCommandHandler::CtcpReply_version(Message msg)
{
