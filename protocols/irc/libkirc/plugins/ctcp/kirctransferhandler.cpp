...
TransferServer *TransferHandler::createServer(Engine *engine, QString m_userName, Transfer::Type type, QString fileName, quint32 fileSize)
{
...
Transfer *TransferHandler::createClient(
    ...
    QHostAddress peer_address, quint16 peer_port, Transfer::Type type, QString fileName, quint32 fileSize)
{
