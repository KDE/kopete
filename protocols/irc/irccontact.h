 ...
 */
class IRCContact
	: public KopeteContact
{
	Q_OBJECT

public:
	IRCContact(IRCContactManager *contactManager, const QString &nick, KopeteMetaContact *metac, KopeteContact::AddMode mode, const QString& icon = QString::null );
	~IRCContact();
