...
#else
		dbus_message_set_auto_start(d->msg, aa);
#endif
	}
...
#else
		return dbus_message_get_auto_start(d->msg);
#endif
	}
...
#define APER &
	...
	{
		dbus_message_append_args( d->msg, DBUS_TYPE_BYTE, APER byte,
								  DBUS_TYPE_INVALID );
		return *this;
	}
	...
	{
		dbus_message_append_args( d->msg, DBUS_TYPE_INT32, APER num,
								  DBUS_TYPE_INVALID );
		return *this;
	}
	...
	{
		dbus_message_append_args( d->msg, DBUS_TYPE_UINT32, APER num,
								  DBUS_TYPE_INVALID );
		return *this;
	}
	...
	{
		dbus_message_append_args( d->msg, DBUS_TYPE_INT64, APER num,
								  DBUS_TYPE_INVALID );
		return *this;
	}
	...
	{
		dbus_message_append_args( d->msg, DBUS_TYPE_UINT64, APER num,
								  DBUS_TYPE_INVALID );
		return *this;
	}
	...
	{
		dbus_message_append_args( d->msg, DBUS_TYPE_DOUBLE, APER num,
								  DBUS_TYPE_INVALID );
		return *this;
	}
