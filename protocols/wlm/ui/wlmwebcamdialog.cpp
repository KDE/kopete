...
WlmWebcamDialog::WlmWebcamDialog( const QString &contactId, QWidget * parent )
: KDialog( parent )
{
...
WlmWebcamDialog::~ WlmWebcamDialog( )
{
#ifndef Q_OS_WIN
...
void WlmWebcamDialog::slotUpdateImage()
{
#ifndef Q_OS_WIN
	mVideoDevicePool->getFrame();
