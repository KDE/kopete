...
SMSContact::SMSContact(Kopete::Account *_account, const QString &phoneNumber, Kopete::MetaContact *parent)
    : Kopete::Contact(_account, phoneNumber, parent)
...
void SMSContact::serialize(QMap<QString, QString> &serializedData, QMap<QString, QString> & /* addressBookData */)
{
