...
#  EXECUTE_PROCESS(COMMAND gcc -o ortpversion -lortp ${LIBORTP_INCLUDE_DIR} ortpversion.c RESULT_VARIABLE result)
#  MESSAGE(gcc -o ortpversion -lortp ${LIBORTP_INCLUDE_DIR} ortpversion.c)
#  MESSAGE(${result})
