...
IF( LIBOTR_INCLUDE_DIR AND LIBOTR_LIBRARY )
  ...
  # Check if version is at least 3.1.0
  MACRO_ENSURE_VERSION("3.1.0" ${LIBOTR_VERSION} LIBOTR_FOUND)
  ...
  ELSE( LIBOTR_FOUND )
    MESSAGE(STATUS "libotr version 3.1.0 or greater required but found ${LIBOTR_VERSION}.")
  ENDIF( LIBOTR_FOUND )
